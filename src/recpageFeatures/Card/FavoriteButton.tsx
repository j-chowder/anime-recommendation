...
const Star = styled.svg`
 ...
 height: 24px;
`
export default function FavoriteButton({toggleFavorite, favorited}: {favorited: boolean, toggleFavorite: () => void}){
    ...
    return (
        <Container>
             <svg fill={currentColor} className = {favorited ? 'favorited' : ''} width="24px" height="24px" viewBox="0 -0.59 29.018 29.018" id="_25_-_Star" data-name="25 - Star" xmlns="http://www.w3.org/2000/svg" onClick = {toggleFavorite}>
